...
part = ''
diet_type = -1
df = pd.read_csv('/Users/qiuyipei/VsCode/TheoryOfComputation/LineChatBot-master/food.csv')
...
class TocMachine(GraphMachine):
    ...
    def on_enter_input_gender(self, event):
        title = '請先提供您的基本資訊'
        text = '您是『男生』還是『女生』'
        btn = [MessageTemplateAction(label = '男生', text ='男生'), MessageTemplateAction(label = '女生',text = '女生'),]
